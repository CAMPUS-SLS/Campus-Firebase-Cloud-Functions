...
exports.getStudentEvents = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
    if (req.method !== "GET") {
...
exports.updateStudentEvents = functions.https.onRequest((req, res) => {
  cors(req, res, async () => {
...
exports.createStudentEvents = functions.https.onRequest((req, res) => {
